...
class _View_Details0 extends import1.AppView<import0.Details> {
  ...
  createInternal(rootSelector:string):import3.AppElement {
    ...
    this._text_23 = this.renderer.createText((null as any),'uploadImage',(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import34.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 25)))) { return this._Content_9_4.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
