...
export class Wrapper_LiveDetail {
  context:import0.LiveDetail;
  changed:boolean;
  constructor(p0:any) {
    this.changed = false;
...
var renderType_LiveDetail_Host:import2.RenderComponentType = (null as any);
class _View_LiveDetail_Host0 extends import1.AppView<any> {
  _el_0:any;
  /*private*/ _appEl_0:import3.AppElement;
  _LiveDetail_0_4:Wrapper_LiveDetail;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement) {
    super(_View_LiveDetail_Host0,renderType_LiveDetail_Host,import6.ViewType.HOST,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import3.AppElement {
    this._el_0 = this.selectOrCreateHostElement('page-live',rootSelector,(null as any));
    this._appEl_0 = new import3.AppElement(0,(null as any),this,this._el_0);
    var compView_0:any = viewFactory_LiveDetail0(this.viewUtils,this.injector(0),this._appEl_0);
    this._LiveDetail_0_4 = new Wrapper_LiveDetail(this.parentInjector.get(import8.NavParams));
    this._appEl_0.initComponent(this._LiveDetail_0_4.context,([] as any[]),compView_0);
    compView_0.create(this._LiveDetail_0_4.context,this.projectableNodes,(null as any));
    this.init(([] as any[]).concat([this._el_0]),[this._el_0],([] as any[]),([] as any[]));
    return this._appEl_0;
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import0.LiveDetail) && (0 === requestNodeIndex))) { return this._LiveDetail_0_4.context; }
...
function viewFactory_LiveDetail_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement):import1.AppView<any> {
  if ((renderType_LiveDetail_Host === (null as any))) { (renderType_LiveDetail_Host = viewUtils.createRenderComponentType('',0,import9.ViewEncapsulation.None,([] as any[]),{})); }
  return new _View_LiveDetail_Host0(viewUtils,parentInjector,declarationEl);
}
export const LiveDetailNgFactory:import10.ComponentFactory<import0.LiveDetail> = new import10.ComponentFactory<import0.LiveDetail>('page-live',viewFactory_LiveDetail_Host0,import0.LiveDetail);
const styles_LiveDetail:any[] = ([] as any[]);
var renderType_LiveDetail:import2.RenderComponentType = (null as any);
class _View_LiveDetail0 extends import1.AppView<import0.LiveDetail> {
  _el_0:any;
  ...
  /*private*/ _expr_3:any;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement) {
    super(_View_LiveDetail0,renderType_LiveDetail,import6.ViewType.COMPONENT,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import3.AppElement {
    ...
    this._Navbar_2_4 = new import12.Wrapper_Navbar(this.parentInjector.get(import18.App),this.parentInjector.get(import17.ViewController,(null as any)),this.parentInjector.get(import19.NavController,(null as any)),this.parentInjector.get(import15.Config),new import16.ElementRef(this._el_2),this.renderer);
    ...
    this._ToolbarTitle_4_4 = new import13.Wrapper_ToolbarTitle(this.parentInjector.get(import15.Config),new import16.ElementRef(this._el_4),this.renderer,this.parentInjector.get(import20.Toolbar,(null as any)),this._Navbar_2_4.context);
    ...
    this._Content_9_4 = new import14.Wrapper_Content(this.parentInjector.get(import15.Config),new import16.ElementRef(this._el_9),this.renderer,this.parentInjector.get(import18.App),this.parentInjector.get(import21.Keyboard),this.parentInjector.get(import22.NgZone),this.parentInjector.get(import17.ViewController,(null as any)),this.parentInjector.get(import23.Tabs,(null as any)));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import26.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 10)))) { return this._Content_9_4.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
...
export function viewFactory_LiveDetail0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement):import1.AppView<import0.LiveDetail> {
  if ((renderType_LiveDetail === (null as any))) { (renderType_LiveDetail = viewUtils.createRenderComponentType('',0,import9.ViewEncapsulation.None,styles_LiveDetail,{})); }
